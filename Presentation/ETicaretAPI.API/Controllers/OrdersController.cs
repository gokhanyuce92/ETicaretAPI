...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefinition(Menu = AuthorizeDefitionConstants.Orders, ActionType = ActionType.Reading, Definition = "Get Order By Id")]
        ...
        [HttpGet]
        [AuthorizeDefinition(Menu = AuthorizeDefitionConstants.Orders, ActionType = ActionType.Reading, Definition = "Get All Orders")]
        ...
        [HttpPost]
        [AuthorizeDefinition(Menu = AuthorizeDefitionConstants.Orders, ActionType = ActionType.Writing, Definition = "Create Order")]
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefitionConstants.Orders, ActionType = ActionType.Updating, Definition = "Complete Order")]
